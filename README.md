...
- **Pieza reto "Tuerca"**: una pieza de 3×3 con un agujero vacío en el centro que no se rellena al fijarse, dejando un hueco atrapado en la pila hasta limpiar esa línea.
